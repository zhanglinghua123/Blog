...
webpackJsonpL2Dwidget([0], {
    76: function (t, e, i) {
        ...
        var r,
            ...
            l = i(79),
            $ = i(39),
            u = ((r = $), r && r.__esModule ? r : { default: r }),
            p = i(37)
        var c = null,
            f = void 0,
            g = !1,
            ...
            'touchstart' == t.type
                ...
                ? (function (t) {
                      var e = n.currCanvas.getBoundingClientRect(),
                          ...
                          r = D(t.clientY - e.top),
                          o = v(
                              { x: e.left + e.width / 2, y: e.top + e.height * S },
        ...
        (function (t) {
            ...
            (r._$0s = 1),
                ...
                (r.prototype.getParamFloat = function (t) {
                    return (
                        'number' !== typeof t && (t = this._$5S.getParamIndex(l.getID(t))), this._$5S.getParamFloat(t)
                    )
                }),
            ...
            (o.CHANNEL_COUNT = 4),
                ...
                (o.prototype.calcClippedDrawTotalBounds = function (t, e) {
                    for (
                        ...
                        if (u._$yo()) {
                            for (
                                var p = u.getTransformedPoints(), c = p.length, f = [], g = [], d = 0, y = B._$i2;
                                y < c;
                                y += B._$No
                            )
                                (f[d] = p[y]), (g[d] = p[y + 1]), d++
                    ...
                    if (e._$AT && !e._$9L) {
                        ...
                        (0 <=
                            (o =
                                ...
                                (0 == this._$eo || e._$Do < 0 ? 1 : _t._$r2((e._$Do - i) / this._$eo))) &&
                            o <= 1) ||
                            console.log('### assert!! ### '),
            ...
            (S._$Z2 = function (t, e, i, r) {
                ...
                if (3 == o) {
                    var p = r[n[0]],
                        ...
                        P = (($ = s[0]), (u = s[1]), s[2])
                    return (
                        ((S = ((a = (p + (c - p) * $) | 0) + ((_ = (f + (g - f) * $) | 0) - a) * u) | 0) +
                            ((((h = (d + (y - d) * $) | 0) + ((l = (m + (T - m) * $) | 0) - h) * u) | 0) - S) * P) |
                        0
                    )
                }
                if (4 == o) {
                    ...
                    return (
                        ((S =
                            ((a = ((p = (v + (L - v) * $) | 0) + ((c = (M + (E - M) * $) | 0) - p) * u) | 0) +
                                ((_ = ((f = (x + (A - x) * $) | 0) + ((g = (I + (w - I) * $) | 0) - f) * u) | 0) - a) *
                                    P) |
                            0) +
                            ((((h = ((d = (D + (O - D) * $) | 0) + ((y = (b + (R - b) * $) | 0) - d) * u) | 0) +
                                ((l = ((m = (F + (C - F) * $) | 0) + ((T = (N + (B - N) * $) | 0) - m) * u) | 0) - h) *
                                    P) |
                                0) -
                                S) *
                                G) |
                ...
                (S._$br = function (t, e, i, r) {
                    ...
                    if (4 == o) {
                        ...
                        return (
                            (1 - B) *
                                ((1 - N) * ((1 - T) * (P + (S - P) * $) + T * (v + (L - v) * $)) +
                                    N * ((1 - T) * (M + (E - M) * $) + T * (x + (A - x) * $))) +
                            B *
                                ((1 - N) * ((1 - T) * (I + (w - I) * $) + T * (D + (O - D) * $)) +
                                    N * ((1 - T) * (b + (R - b) * $) + T * (F + (C - F) * $)))
                        )
                    }
                ...
                (S._$Vr = function (t, e, i, r, o, n, s, a) {
                    ...
                    if (_ <= 0) {
                        ...
                        else for (var c = 0; c < $;) (n[u] = p[c++]), (n[u + 1] = p[c++]), (u += a)
                    } else if (1 == _) {
                        p = o[h[0]]
                        var f = o[h[1]],
                            g = 1 - (m = l[0])
                        ...
                        for (c = 0; c < $;)
                            {(n[u] =
                                R * L[c] + F * M[c] + C * E[c] + N * x[c] + B * I[c] + G * w[c] + U * D[c] + Y * O[c]),
                                ++c,
                                (n[u + 1] =
                                    R * L[c] +
                                    F * M[c] +
            ...
            (x._$ur = -2),
                ...
                (x.prototype.interpolateOpacity = function (t, e, i, r) {
                    null == this._$mS
                        ...
                        : i.setInterpolatedOpacity(S._$br(t, e, r, this._$mS))
                }),
            ...
            (O.prototype.identity = function () {
                ...
                (O.prototype.mult = function (t, e, i) {
                    return null == e
                        ? null
                        : (this == e ? this.mult_safe(this.m, t.m, e.m, i) : this.mult_fast(this.m, t.m, e.m, i), e)
                }),
            ...
            (R._$kS = -1),
                ...
                (R.prototype.transform = function (t, e, i) {
                    ...
                    switch (this._$hi) {
                        ...
                        case R._$go | R._$fo | R._$gb:
                            for (
                                r = this._$7, o = this._$H, n = this._$k, s = this._$f, a = this._$g, _ = this._$w;
                                --i >= 0;
                ...
                (R.prototype._$RT = function (t) {
                    ...
                    0 == n
                        ...
                        : ((t[0] = n), (t[1] = s / n), (t[2] = (r * o + e * i) / s), (t[3] = Math.atan2(r, e)))
                }),
            ...
            (F.prototype = new s()),
                                    ...
                                    if (('a' <= n && n <= 'z') || ('A' <= n && n <= 'Z') || '_' == n) {
                                        ...
                                        if (l >= 0) {
                                            ...
                                            w.startsWith(t, h, F._$cs)
                                                ? ((s._$RP = N._$hs), (s._$4P = new String(t, h, l - h)))
                                                ...
                                                : ((s._$RP = N._$Fr), (s._$4P = new String(t, h, l - h))),
                                                e.motions.push(s)
                                            var a = 0
                                            for (
                                                F._$D2.clear(), o = l + 1;
                ...
                (F.prototype.updateParamExe = function (t, e, i, r) {
                    for (
                        var o = ((e - r._$z2) * this._$D0) / 1e3, n = 0 | o, s = o - n, a = 0;
                        ...
                        for (s = 0; s < g; ++s) {
                            ...
                            if (null != m) {
                                ...
                                (null == T || T == d || this.getBaseDataIndex(T) >= 0) &&
                                    (this._$3S.push(m), this._$db.push(n[s]), (r[s] = null), (y = !0))
                            }
                        }
                        if (!y) break
                    }
            ...
            (Y._$0T = function (t) {
                ...
                (Y._$0T = function (t) {
                    ...
                    for (
                        var e, i = t.length(), r = new Int8Array(i), o = new _$Xs(new _$kb(t), 8192), n = 0;
                        (e = o.read(r, n, i - n)) > 0;
                ...
                (z.prototype._$nb = function (t, e, i, r, o, n, s) {
                    ...
                    for (
                        var a,
                            ...
                            $ = Math.sin(vt._$bS * l._$qT),
                            u = Math.cos(vt._$bS * l._$qT),
                            p = h.getTotalScale(),
                            c = l.reflectX ? -1 : 1,
                            f = l.reflectY ? -1 : 1,
                            g = u * p * c,
                        ...
                        (a = i[v]), (_ = i[v + 1]), (r[v] = g * a + d * _ + T), (r[v + 1] = y * a + m * _ + P)
                }),
                        ...
                        {if ('#' != n)
                            {if ('$' != n) {
                                if ((97 <= s && s <= 122) || (65 <= s && s <= 90) || '_' == n) {
                                    ...
                                    if (u >= 0) {
                                        var a = new N()
                                        w.startsWith(t, $, J._$cs)
                                            ? ((a._$RP = N._$hs), (a._$4P = w.createString(t, $, u - $)))
                                            : w.startsWith(t, $, J._$ar)
                                            ? ((a._$4P = w.createString(t, $ + 7, u - $ - 7)),
                                              w.startsWith(t, $ + 7, 'ANCHOR_X')
                                                  ? (a._$RP = N._$xs)
                                                  : w.startsWith(t, $ + 7, 'ANCHOR_Y')
                                                  ? (a._$RP = N._$us)
                                                  : w.startsWith(t, $ + 7, 'SCALE_X')
                                                  ? (a._$RP = N._$qs)
                                                  : w.startsWith(t, $ + 7, 'SCALE_Y')
                                                  ? (a._$RP = N._$Ys)
                                                  : w.startsWith(t, $ + 7, 'X')
                                                  ? (a._$RP = N._$ws)
                                                  : w.startsWith(t, $ + 7, 'Y') && (a._$RP = N._$Ns))
                                            : ((a._$RP = N._$Fr), (a._$4P = w.createString(t, $, u - $))),
                                            e.motions.push(a)
                                        var _ = 0,
                                            h = []
                                        for (o = u + 1; o < r && '\r' != (n = Q(t, o)) && '\n' != n; ++o)
            ...
            (Z.prototype = new x()),
                ...
                (Z.transformPoints_sdk2 = function (e, i, r, o, n, s, a, _) {
                    for (
                        var h, l, $, u = r * n, p = 0, c = 0, f = 0, g = 0, d = 0, y = 0, m = !1, T = o;
                        T < u;
                        T += n
                    ) {
                        var P, S, v, L
                        if (((v = e[T]), (S = (L = e[T + 1]) * _), (P = v * a) < 0 || S < 0 || a <= P || _ <= S)) {
                            ...
                            if (!m) {
                                ...
                                (p -= 0.5 * ((f = 0.5 * (E + A)) + (d = 0.5 * (E - A)))),
                                    (c -= 0.5 * ((g = 0.5 * (x + I)) + (y = 0.5 * (x - I))))
                            }
                            if (-2 < v && v < 3 && -2 < L && L < 3)
                                {if (v <= 0)
                                    {if (L <= 0) {
                            ...
                            {(h = 2 * ((0 | P) + (0 | S) * (a + 1))),
                                (l = P - (0 | P)) + ($ = S - (0 | S)) < 1
                                    ? ((i[T] = s[h] * (1 - l - $) + s[h + 2] * l + s[h + 2 * (a + 1)] * $),
                                      (i[T + 1] = s[h + 1] * (1 - l - $) + s[h + 3] * l + s[h + 2 * (a + 1) + 1] * $))
                                    : ((i[T] =
                                          s[h + 2 * (a + 1) + 2] * (l - 1 + $) +
                                          s[h + 2 * (a + 1)] * (1 - l) +
                                          s[h + 2] * (1 - $)),
                    ...
                    for (
                        ...
                        {at._$ts
                            ...
                            : ((u = (a = i[m] * f) - (0 | a)),
                              ...
                              ($ = 2 * ((0 | a) + (0 | _) * (f + 1)))),
                            u + p < 1
                                ? ((r[m] = y[$] * (1 - u - p) + y[$ + 2] * u + y[$ + 2 * (f + 1)] * p),
                                  (r[m + 1] = y[$ + 1] * (1 - u - p) + y[$ + 3] * u + y[$ + 2 * (f + 1) + 1] * p))
                                : ((r[m] =
                                      y[$ + 2 * (f + 1) + 2] * (u - 1 + p) +
                                      y[$ + 2 * (f + 1)] * (1 - u) +
                                      y[$ + 2] * (1 - p)),
            ...
            (ot.tr = new gt()),
                ...
                (ot.prototype._$bL = function () {
                    ...
                    var t = this.viewport
                    null != t &&
                        (this.context.beginPath(), this.context._$Li(t[0], t[1], t[2], t[3]), this.context.clip())
                }),
                            ...
                            if ((n || (n = 1.2), at.IGNORE_EXPAND && (n = 0), at.USE_CACHED_POLYGON_IMAGE)) {
                                ...
                                if (((et.gl_cacheImage = et.gl_cacheImage || {}), !et.gl_cacheImage[S])) {
                                    ...
                                    rt.translate(-Q, -Z),
                                        ...
                                        rt.drawImage(t, 0, 0),
                                        (et.gl_cacheImage[S] = { cacheCanvas: it, cacheContext: rt })
                                }
            ...
            (lt.prototype = new W()),
                ...
                (lt.prototype._$Nr = function (t, e) {
                    ...
                    if (
                        ...
                        this._$GS._$Ur(t) && (W.prototype._$Nr.call(this, t, i), !i._$IS[0]))
                    ) {
                        var r = lt._$gT;
            ...
            (ct.prototype._$tb = function () {
                ...
                (ct.prototype.startMotion = function (t, e) {
                    ...
                    var n = i._$sr
                    return (
                        this._$eb && a._$Ji('MotionQueueManager[size:%2d]->startMotion() / new _$w0 (m%d)\n', r, n), n
                    )
                }),
            ...
            (vt._$2S = Math.PI / 180),
                ...
                (vt._$kT = [
                    ...
                    0.12337, 0.135634, 0.147877, 0.160098, 0.172295, 0.184465, 0.196606, 0.208718, 0.220798, 0.232844,
                    ...
                    0.474802, 0.485651, 0.496425, 0.507124, 0.517745, 0.528287, 0.538748, 0.549126, 0.559421, 0.56963,
                    0.579752, 0.589785, 0.599728, 0.609579, 0.619337, 0.629, 0.638567, 0.648036, 0.657406, 0.666676,
                    0.675843, 0.684908, 0.693867, 0.70272, 0.711466, 0.720103, 0.72863, 0.737045, 0.745348, 0.753536,
                    0.76161, 0.769566, 0.777405, 0.785125, 0.792725, 0.800204, 0.807561, 0.814793, 0.821901, 0.828884,
                    0.835739, 0.842467, 0.849066, 0.855535, 0.861873, 0.868079, 0.874153, 0.880093, 0.885898, 0.891567,
                    0.897101, 0.902497, 0.907754, 0.912873, 0.917853, 0.922692, 0.92739, 0.931946, 0.936359, 0.940629,
                    0.944755, 0.948737, 0.952574, 0.956265, 0.959809, 0.963207, 0.966457, 0.96956, 0.972514, 0.97532,
            ...
            (Mt._$W2 = 0),
                ...
                (Mt.setup = function () {
                    ...
                    if ((i = t.indexOf('iPhone OS ')) >= 0)
                        (r.os = 'iPhone'), (r._isIPhone = !0), (r.version = e(t, i + 'iPhone OS '.length))
                        ...
                        {(i = t.indexOf('Android')) >= 0
                            ? ((r.os = 'Android'), (r._isAndroid = !0), (r.version = e(t, i + 'Android '.length)))
                            : ((r.os = '-'), (r.version = -1))}
                }),
                at.init()
            i = !1;
    ...
    78: function (t, e, i) {
        ...
        (o.prototype.getModelMatrix = function () {
            ...
            (o.prototype.loadModelData = function (t, e) {
                ...
                i.loadLive2DModel(t, function (t) {
                    ...
                    0 == r.Live2D.getError()
                        ? ((o.modelMatrix = new $(o.live2DModel.getCanvasWidth(), o.live2DModel.getCanvasHeight())),
                ...
                switch (this.eyeState) {
                    case h.STATE_CLOSING:
                        (o = (i - this.stateStartTime) / this.closingMotionMsec) >= 1 &&
                            ((o = 1), (this.eyeState = h.STATE_CLOSED), (this.stateStartTime = i)),
                            (e = 1 - o)
                        break
                    case h.STATE_CLOSED:
        ...
        (l.mul = function (t, e, i) {
            ...
            for (r = 0; r < 4; r++)
                for (o = 0; o < 4; o++) for (n = 0; n < 4; n++) s[r + 4 * o] += t[r + 4 * n] * e[n + 4 * o]
        ...
        (p.load = function (t) {
            for (
                var e = new p(), i = y.getPlatformManager().jsonParseFromBytes(t).physics_hair, o = i.length, n = 0;
                n < o;
                n++
            ) {
                var s = i[n],
        ...
        (c.load = function (t) {
            for (
                var e = new c(), i = y.getPlatformManager().jsonParseFromBytes(t).parts_visible, r = i.length, o = 0;
                o < r;
                o++
            ) {
                ...
                for (n = 0; n < e.length; n++)
                    {if (!((s = e[n].partsIndex) < 0))
                        {if (r == n) t.setPartsOpacity(s, o)
                            ...
                            (1 - (_ = o < 0.5 ? (-0.5 * o) / 0.5 + 1 : (0.5 * (1 - o)) / 0.5)) * (1 - o) > 0.15 &&
                                (_ = 1 - 0.15 / (1 - o)),
                                h > _ && (h = _),
    ...
    84: function (t, e, i) {
        ...
        (a.prototype.createModel = function () {
            ...
            (a.prototype.changeModel = function (t, e) {
                this.reloadFlg &&
                    ((this.reloadFlg = !1), this.releaseModel(0, t), this.createModel(), this.models[0].load(t, e))
            }),
